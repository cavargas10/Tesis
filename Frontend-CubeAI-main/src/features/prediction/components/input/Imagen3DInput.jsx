...
export const Imagen3DInput = ({ isCollapsed }) => {
  ...
  useEffect(() => {
    if (taskStatus === "SUCCESS" && taskData) {
      dispatch({ type: 'SET_PREDICTION', payload: { type: 'img3d', result: taskData } });
      clearSubmissionError();
  ...
  const handleLocalPrediction = async () => {
    ...
    await submitPrediction("imagen3D", formData);
            ...
            <div className="bg-gray-50 dark:bg-principal/30 backdrop-blur-sm border border-gray-200 dark:border-linea/20 rounded-2xl p-4 h-full flex flex-col space-y-4">
              ...
              <div className="flex-grow flex flex-col min-h-0">
                ...
                <div
                  ...
                  onDrop={isUIBlocked ? undefined : handleDrop} // Disable drop if UI is blocked
                  onClick={() => !isUIBlocked && document.getElementById("fileInput-imagen3d").click()}
                >
                  <input
